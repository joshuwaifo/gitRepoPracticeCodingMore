...
try:
    ...
    def gram_matrix(x):
        ...
        features = K.batch_flatten(K.permute_dimensions(
            x,
            (
                2,
                0,
    ...
    target_image_path_type_str = 'data/josh.jpeg'
    style_reference_image_path_type_str = 'data/nft_image.png'

    width, height = load_img( target_image_path_type_str )
    img_height = 400
    img_width = int( width * img_height / height )

    from keras import backend as K

    target_image = K.constant( preprocess_image( target_image_path_type_str ) )
    style_reference_image = K.constant( preprocess_image( style_reference_image_path_type_str ) )
    ...
    target_image_features = layer_features[
        0,
        :,
        :,
        :
    ...
    print( "I think the loading of the image might cause a problem" )
